    ...
    implements android.view.SurfaceHolder.Callback
{
    ...
    private void computeSamplePoints(int i)
    {
        ...
        Iterator iterator = mAmpPoints.iterator();
...
//        if(mBackground == null)
//        {
//            mBackground = getResources().getDrawable(2130837587);
//            int i = mLocation[1];
//            int j = getHeight();
//            mBackground.setBounds(0, -i, getWidth(), i + j + i);
//        }
